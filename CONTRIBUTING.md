...
we suggest you create a performance based test before hand before refactoring.  Your initial test should be set to a known performance number, even if it is really bad. 
